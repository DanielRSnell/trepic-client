...
export default class TopComponent extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Grid columns={2} stackable verticalAlign='middle' style={{background: `linear-gradient(0deg,rgba(0, 0, 0,0.5),rgba(0, 0, 0,0.65)),url(${this.props.story.profile.meta_box.cover[0].full_url}) 50% 50% no-repeat`, height: '60vh', width: '100%'}}>
      ...
      <Grid.Column style={{marginLeft: '3rem', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%'}} textAlign='center' verticalAlign='middle'>
        ...
        {this.props.story.profile.meta_box.location}
              ...
              <p style={{color: 'white', fontSize: '1.15rem', marginTop: '1rem', padding: 10, marginBottom: '1rem'}}>{this.props.story.profile.meta_box.about}</p>
        </Grid.Column>
        <Grid.Column />
        </Grid.Row>
        </Grid>
